...
const articlesData = [
    ...
    },
    {
        ...
        content: [
            ...
            "Romania's Transylvania region offers more than just Dracula legends. The fortified churches, medieval towns like Sighișoara, and the Carpathian Mountains provide a rich cultural and natural experience. The region's traditional villages maintain centuries-old customs and architecture.",
    ...
    },
    {
        ...
        content: [
            ...
            "Mastering the pour-over technique involves a consistent, controlled pour in a spiral pattern, starting from the center and moving outward. This ensures even saturation of the coffee grounds. The bloom—pouring a small amount of water to let the coffee degas—is essential for fresh beans and should last 30-45 seconds.",
            "Patience and practice are key to perfecting your brewing technique. Keep a brewing journal to track variables like grind size, water temperature, brew time, and ratios. Small adjustments can make significant differences in flavor. With time and experimentation, you'll develop the skills to consistently brew coffee that rivals your favorite café."
        ]
    }
];
